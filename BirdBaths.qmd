...
Like bioregions, the plot of urban and rural observations is highly similar to the one made in the EDA. Urban observations make up about 60% of the observations while 
```{r}
#| echo: false
#| message: false
#| output: false
