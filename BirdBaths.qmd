...
Between the two years, 2014 saw more birds than 2015 by a slim margin. 2014 sightings represent 52% of the sightings while 2015 represents the other 47%. Despite the different seasons, it seems like the total amount of birds did not vary by much.
...
By comparing bioregions by year, there is a clear difference in distribution. In 2014, in winter, there were only a 5 bioregions that birds were observed in. Sydney Basin observations made up the majority of the 2014 bird count with over 700 birds tracked. In contrast, 2015 featured observations of birds from every bioregion. The Sydney Basin is accompanied by SE Queensland and SE Highlands as the most common bioregions, all with around 200 observations each.
