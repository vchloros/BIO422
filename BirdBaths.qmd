...
(Compare observations to iNaturalist & eBird figures)

In addition to that metric, I also used visualization of Australia's bioregions and compared them to the most populated cities.
...
Here is the national division of Australia's bioregions according to the IBRA7. Some of the most populace cities are labeled in the image, like Sydney in it's eponymous basin and Brisbane in SE Queensland. 

As a comparison, I used figures based on data from iNaturalist and eBird to compare how common bird observations were across different areas of Australia. Both maps were created from data collected by both on-going projects between 2014 and 2015
...
(Research migration patterns? or behvior variation between locations & season)
